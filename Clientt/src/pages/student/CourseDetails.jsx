    ...
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      <div className='max-w-xl z-10 text-gray-500'>
        ...
        <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
                ...
                <p className='text-sm'>Course by  <span className='text-blue-600 underline'>Great</span></p>
      ...
      {/* right coloumn */}
      <div className='max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:mon-w-[420px]'>
        {
        ...
        <div className='p-5 '>
          <div className='flex items-center gap-2'>
             ...
             <img className='w-3.5' src={assets.time_clock_icon} alt="time left clock item" />
          ...
          <div className='pt-6'>
            ...
            <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
              ...
              <li>Steps-by-steps, hands-on project-guidance.</li>
