    ...
    setChapters(
      chapters.map((chapter)=>{
        if (chapter.chapterId === currentChapterId){
          ...
          chapter.chapterContent.push(nweLecture);
        }
        return chapter;
      })
    );
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'> 
        ...
        <div className='flex items-center justify-between flex-wrap'>
          ...
          <div className='flex md:flex-row flex-col items-center gap-3'>
            ...
            <label htmlFor="thumbnailImage" className='flex
             items-center gap-3'>
              ...
              <div className='bg-white text-gray-700 p-4 rounded relative w-full max-w-80'>
                ...
                <div className='mb-2'>
                 ...
                 <div className='flex gap-2 my-4'>
                  <p>Is Preview Free?</p>
                  <input type="checkbox" checked={lectureDetails.isPreviewFree} onChange={(e)=> setLectureDetails({...lectureDetails,isPreviewFree: e.target.value})} className='mt-1 scale-125' />
                </div>
